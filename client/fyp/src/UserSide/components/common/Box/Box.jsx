  ...
  const scrollDown = () => {
    ...
    return (
        <div className='curve shadow-lg'>
          <NavBar />
        <div className=" mainbox d-flex flex-column justify-content-center align-items-center text-white" style={{backgroundColor:'rgba(0,0,0,0.5)', backdropFilter : 'blur(0.5px)',  }}>
