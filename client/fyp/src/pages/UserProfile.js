...
const UserProfile = () => {
    ...
    return (
        <div>
         <Row>
           ...
           <Container className='p-4'>
               <div className='px-4 py-3 bg-danger bg-opacity-10 text-white w-25 d-flex justify-content-start align-items-start flex-column' style={{borderRadius:"5px"}}>
                    ...
                    <p style={{marginBottom:'0px'}}><IoHome className="text-dark" style={{marginRight:'5px'}} />{auth?.address}</p>
               </div>
               <div className="mt-4" style={{ border: '1px solid orange'}}>
               <h4 className="text-center my-4">Update Profile</h4>
        ...
        {(latValue && lngValue) && 
                ...
                <Button className='btn w-100'  onClick={getAddress}>
                    Set Location
                </Button>
          </div>
                ...
                >
                    ...
                    <Button onClick={updateInfoHandler} className='w-100'>
                        Submit 
                    </Button>
