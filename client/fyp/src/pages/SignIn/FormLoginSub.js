    ...
    return (
        ...
        <Form  className='' noValidate onSubmit={onSubmit}>
          ...
          <div className='d-flex flex-column'>
            ...
            <Form.Group className="d-flex align-items-center"><input aria-label="Checkbox for following text input" type="Checkbox" className="form-check-input fs-6" style={{}} onClick={() => setRememberMe(!rememberMe)} value={rememberMe} checked={rememberMe} />
            <Form.Label className="my-auto mx-1 text-white" style={{fontSize:'12px'}}>Remember Me</Form.Label></Form.Group>
          </div>
