    ...
    <Container className="px-5 d-flex flex-column justify-content-center align-items-center">
      ...
      <Accordion.Item className="mb-3" eventKey="0">
        ...
        <Accordion.Item className="mb-3" eventKey="1">
          <Accordion.Header className="">
            <h6 style={{ color: "#ef5023" }}>How do I Register?</h6>
          </Accordion.Header>
          <Accordion.Body>
            <p>
              {" "}
              You can register by clicking on the "Register" button on the homepage.
        ...
        <Accordion.Item className="mb-3" eventKey="2">
          <Accordion.Header className="">
            <h6 style={{ color: "#ef5023" }}>How do I sign in?</h6>
          </Accordion.Header>
          <Accordion.Body>
            <p>
              {" "}
              You can sign in by clicking on the "Sign  In" button on the home
              page. You will be redirected to the sign in page.
            </p>
          </Accordion.Body>
        </Accordion.Item>
        ...
        <Accordion.Item className="mb-3" eventKey="13">
          <Accordion.Header className="">
            <h6 style={{ color: "#ef5023" }}>How can i have my restaurant register?</h6>
          </Accordion.Header>
          <Accordion.Body>
            <p>
              {" "}
