            ...
            <Container className='p-5'>
                ...
                <Row className='flex-wrap'> 
                    {restaurants?.map((restaurant, index) =>
                     <Col xl={3} lg={3} md={6} sm={12} xs={12} className='m-2 p-2 ' key={index} style={{backgroundColor:'#f7f2f2', boxShadow: 'rgba(50, 50, 93, 0.25) 0px 2px 5px -1px, rgba(0, 0, 0, 0.3) 0px 1px 3px -1px', borderRadius:'10px'}}>
