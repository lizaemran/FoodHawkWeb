    ...
    <>
      ...
      >
        <Col className="col-2 m-auto">
          <div
            id="status"
            className={isOnline ? "active-status" : "inactive-status"}
          ></div>
          <Link to={`/restaurant/${username}`}>
            <Image
              onClick={restaurantDetailHandler}
              className="p-image"
              src={image}
        ...
        <Col className="col-10">
          {userType === "admin" && (
            <div className="admin-button shadow">
              <a
                onClick={() => {
          ...
          >
            <h1 onClick={restaurantDetailHandler}>{name}</h1>
          </Link>
          <button
            id="btn"
          ...
          <div id="rating">{renderStars(stars)}</div>
          {userType === "admin" && (
            <div id="close" onClick={handleDeletedClick}>
          ...
          <p class="description">
            ...
            <br />
            <b>Delivery Time:</b> 40min
            <br />
            <b>Delivery Fee:</b> Rs. 50
            <br />
          </p>
        </Col>
      </motion.div>
